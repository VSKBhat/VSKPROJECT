...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        // Set chart options
        var options = {
            'title' : 'Count of passwords', //title which will be shown right above the Google Pie Chart
...
<div class="container">
    <h5>The pie chart shows number of users having common password.</h5>
</div>
</body>
</html>
