  ...
  <div class="card bg-dark text-white">
      <img src="Grey.jpg" class="card-img mx-auto" alt="grey">
           <div class="card-img-overlay">
               <div class="text-warning"><h1>IoT Device Details</h1></div> 
        <table border ="1" width="500" align="center" class="text-warning"> 
         <tr> 
          <th><b>Serial No</b></th> 
          <th><b>Username</b></th> 
          <th><b>Password</b></th> 
        ...
        <%-- Fetching the attributes of the request object 
             which was previously set by the servlet  
              "StudentServlet.java" 
        --%>  
        <%ArrayList<Defaultup> std =(ArrayList<Defaultup>)request.getAttribute("data"); 
        for(Defaultup s:std){%> 
