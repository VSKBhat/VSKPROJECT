<%-- 
    Document   : preventSqlinjection
    Created on : 9 Apr, 2019, 12:07:00 PM
    Author     : VeenaSK
--%>
...
<html>
    <head>
        ...
        <title>Non-Vulnerable Page</title>
  ...
  background-size: cover;
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <form action="PreventSqlInjection" method="post">
            <div class="container">
                 <div class="row">
            ...
            User Name:<input type="text" name="id" value="" autocomplete="off" class="form-control"/>
